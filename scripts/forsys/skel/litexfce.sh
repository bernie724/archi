...
xfconf-query -c xfce4-panel -p /plugins/plugin-2/grouping -n -t 'bool' -s 'true' 2> /dev/null
xfconf-query -c xfce4-panel -p /plugins/plugin-2/show-labels -n -t 'bool' -s 'true' 2> /dev/null
...
xfconf-query -c xfce4-desktop -p /backdrop/screen0/"$mon1"/workspace0/last-image -n -t 'string' -s /usr/share/backgrounds/xfce/ondasblue.jpg 2> /dev/null
xfconf-query -c xfce4-desktop -p /backdrop/screen0/"$mon1"/workspace1/last-image -n -t 'string' -s /usr/share/backgrounds/xfce/park.jpg 2> /dev/null
xfconf-query -c xfce4-desktop -p /backdrop/screen0/"$mon1"/workspace2/last-image -n -t 'string' -s /usr/share/backgrounds/xfce/park.jpg 2> /dev/null
...
xfconf-query -c xfce4-panel -p /panels/panel-1/position-locked -n -t 'bool' -s 'false' 2> /dev/null
