...
xfconf-query -c xfce4-desktop -p /backdrop/screen0/monitorVirtual-1/workspace0/last-image -n -t 'string' -s /usr/share/backgrounds/xfce/Aquarius.svg 2> /dev/null
xfconf-query -c xfce4-desktop -p /backdrop/screen0/monitorVirtual-1/workspace1/last-image -n -t 'string' -s /usr/share/backgrounds/xfce/paltanen.jpg 2> /dev/null
xfconf-query -c xfce4-desktop -p /backdrop/screen0/monitorVirtual-1/workspace2/last-image -n -t 'string' -s /usr/share/backgrounds/xfce/Klivia.jpg 2> /dev/null
...
xfconf-query -c xfce4-panel -p /panels/panel-1/leave-opacity -n -t 'int' -s '65' 2> /dev/null
xfconf-query -c xfce4-panel -p /panels/panel-1/enter-opacity -n -t 'int' -s '50' 2> /dev/null
